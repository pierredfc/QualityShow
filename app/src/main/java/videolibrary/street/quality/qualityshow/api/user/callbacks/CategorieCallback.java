...
public class CategorieCallback {
    ...
    public static class GetCategoriesCallback extends Adapter.JsonArrayCallback{
        ...
        private CategorieListener listener;

        public GetCategoriesCallback(CategorieListener listener) {
        ...
        public void onSuccess(JSONArray response) {
            ...
            this.listener.getCategorie(categories);
    ...
    public static class AddCategoryCallback extends Adapter.JsonObjectCallback{
        ...
        public AddCategoryCallback(CategorieListener listener) {
            this.listener = listener;
        }
    ...
    public static class DeleteCategoryCallback implements Adapter.Callback{
        ...
        public DeleteCategoryCallback(CategorieListener categorieListener) {
