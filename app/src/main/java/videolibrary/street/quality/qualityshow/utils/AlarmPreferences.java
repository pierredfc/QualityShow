...
public class AlarmPreferences {
    ...
    public void setAlarmPreferences(Integer newEpisodeID) {
        SharedPreferences prefs = QualityShowApplication.getContext().getSharedPreferences(QualityShowApplication.getContext().getString(R.string.alarm_prefs), Context.MODE_PRIVATE);
        ArrayList<Integer> searches;

        Gson gson = new Gson();
        String json = prefs.getString(QualityShowApplication.getContext().getString(R.string.alarm_prefs_queue), "");
        if (json == "") {
        ...
        prefs.edit().putString(QualityShowApplication.getContext().getString(R.string.alarm_prefs_queue), searchesJson).apply();
    }
    ...
    public void deleteAlarmPreferences() {
        SharedPreferences prefs = QualityShowApplication.getContext().getSharedPreferences(QualityShowApplication.getContext().getString(R.string.alarm_prefs), Context.MODE_PRIVATE);
        prefs.edit().remove(QualityShowApplication.getContext().getString(R.string.alarm_prefs_queue)).apply();
    }
}
